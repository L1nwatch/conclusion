            ...
            "models": [
                ...
                },
                {
                    ...
                    "answers": {
                        ...
                        "opportunityCost": "把上午给零碎任务，就放弃了当天质量最高的注意力。",
                        "inversion": "想保证学不深，只要每天先打开消息并不断切换任务。",
                        "secondOrderEffects": "先完成深度学习会降低拖延带来的持续心理负担。",
                        "circleOfCompetence": "已观察到自己的上午专注度更高，但还需继续记录。",
                        "disconfirmingEvidence": "如果连续两周上午产出更低，就应调整时间。",
                    },
                },
            ],
        },
