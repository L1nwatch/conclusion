            ...
            "models": [
                {
                    ...
                    "model_version": 1,
                    "answers": {
                        "tenHours": "当天更早完成高难度任务，晚些时候压力更小。",
                        "tenDays": "连续执行后，更容易形成稳定的启动习惯。",
                        "tenMonths": "长期积累的完整专注时段会显著增加。",
                        "tenYears": "具体时段不重要，保护长期深度工作的习惯更重要。",
                    },
                },
                {
                    ...
                    "model_version": 1,
                    "answers": {
                        "risk": "主要风险是挤压睡眠；不能用早起掩盖休息不足。",
                        "preparation": "已有两周注意力记录，但仍需继续观察上午产出。",
                        "humility": "只知道自己的近期节律，不能外推到所有人或所有阶段。",
                        "allocation": "把最清醒的时间给长期学习，比先处理零碎消息更有价值。",
                        "change": "如果固定会议或睡眠节律变化，就需要重新安排。",
                        "focus": "真正重要的是每天保护完整专注时段，而非执着于具体钟点。",
                    },
                },
            ],
        },
